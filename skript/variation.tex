...
\rhead{Euler-Lagrange-Gleichungen}
...
In einem Variationsproblem wird jetzt aber eine Funktion $x(t)$ gesucht,
...
\subsection{Euler-Lagrange-Gleichung zu einem Variationsproblem}
