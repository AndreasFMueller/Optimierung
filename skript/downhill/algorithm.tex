...
\begin{figure}[h]
\input{downhill/algorithmus1.pgf}
...
Es ist nat"urlich eher Zufall, wenn man gleich bei der ersten Wahl des Simplex das Minimum trifft, meistens hat man es nicht getroffen und es wird nun auf Grund des gew"ahlten Simplex gem"ass \chapref{sec:downhillModi} ein neues Simplex gebildet.
...
\begin{figure}[h]
\input{downhill/algorithmus2.pgf}
...
Wird es hingegen zu klein gew"ahlt, zieht es sich zu schnell zusammen ohne dass es sich auf ein Minimum zubewegt (siehe \chapref{sec:downhillZusammenziehen}).\\
